...
- `docs/quant-agent-matrix.md` — 适配 QMT+A 股的 9 节点量化代理矩阵
...
- **WSL side** — 因子研究、策略原型、Jupyter、snapshot / diff 审计、量化代理矩阵
- **Shared codebase** — API client、server routers、研究工具库、代理矩阵定义
